...
function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      let req = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/auth/empLogin`, {
        method: "POST",
        headers: {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                    <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" onClick={()=>setShowPassword(s=>(!s))}>
