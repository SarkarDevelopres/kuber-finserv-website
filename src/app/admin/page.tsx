...
function Admin() {
    ...
    const generateDummyData = () => {
        ...
        const loans: LoanData[] = [
            { userId: "user_001", loanType: "Personal", amount: 15000, createdAt: new Date().toISOString() },
            { userId: "user_042", loanType: "Business", amount: 75000, createdAt: new Date(Date.now() - 86400000).toISOString() },
            { userId: "user_156", loanType: "Education", amount: 25000, createdAt: new Date(Date.now() - 172800000).toISOString() },
            { userId: "user_289", loanType: "Home", amount: 200000, createdAt: new Date(Date.now() - 259200000).toISOString() },
            { userId: "user_332", loanType: "Personal", amount: 18000, createdAt: new Date(Date.now() - 345600000).toISOString() },
        ];
